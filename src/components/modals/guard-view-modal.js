...
const GuardViewModal = ({id, visible, setVisible}) => {
  const {getGuard} = useContext(APIContext)
      ...
      <Modal visible={visible} onDismiss={close}>
        {isLoading ? (
          ...
          <ModalContent>
            ...
            <Paragraph>{getGuardInterval(data.frequency, data.frequency_basis)}</Paragraph>
            ...
            <DataTable>
              ...
              <DataTable.Row>
                ...
                <DataTable.Cell>{price(data.threshold)}</DataTable.Cell>
              </DataTable.Row>
